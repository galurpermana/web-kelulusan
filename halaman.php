                          ...
                          <div class="row">
                            <div class="col-lg-12">
                              ...
                              ?>
                                ...
                                <h3 class="text-white">SELAMAT! ANDA DINYATAKAN LULUS DARI SMK NEGERI 2 BALIKPAPAN <br>TAHUN AJARAN 2021/2022</h3><hr class="text-white"><br>
                                <div class="row">
                                  <div class="col-lg-6">
    ...
    <div class="container">
        <div class="col-lg-12">
          <div class="copyright-text"><br>
            <p >Copyright © 2022 Rekayasa Perangkat Lunak Gen.4 
            </p>
          </div>
        </div>
      </div>
